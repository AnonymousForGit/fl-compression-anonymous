...
NUM_CLIENTS="${1:-2}"
CLIENT_CONFIG="${2:-./resources/configs/caltech101/client_1.yaml}"

ERROR_BOUNDS=("1e-3" "1e-2" "3e-2" "5e-2" "1e-1")

declare -a SERVER_CONFIGS=(
  "./resources/configs/caltech101/server_predictor.yaml"
  "./resources/configs/caltech101/server_sz3.yaml"
)
